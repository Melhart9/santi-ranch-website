    ...
    <div className="page-enter">
      <div className="bg-primary text-white text-center pt-40 pb-20 px-6 relative overflow-hidden">
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <h1 className="font-serif text-[clamp(36px,5vw,60px)] font-normal mb-4">Sobre Dos Arroyos</h1>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <p className="text-base text-[var(--text-muted)] leading-relaxed mb-6">
              En Dos Arroyos, creemos que la agricultura responsable es la base de un futuro sustentable. Cada animal que criamos, cada cultivo que sembramos y cada producto que creamos refleja nuestro compromiso con la calidad, la ética y la responsabilidad ambiental.
            </p>
