        ...
        <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-white/80 text-lg leading-relaxed font-light">
              Fundado en 1987 por la familia Mendoza, el Rancho TerraVerde ha crecido de una pequeña operación ganadera a uno de los negocios agrícolas más diversificados de la región. Creemos en trabajar con la tierra, no en contra de ella.
            </p>
